...
with open("recruitingest-extension/content/context_profiles.js", "r") as f:
    content = f.read()

prefix = content.split("""panel.innerHTML = window.getPanelShell(`
    <div style="padding: 4px 0;">""")[0]

new_code = """panel.innerHTML = window.getPanelShell(\`
...
with open("recruitingest-extension/content/context_profiles.js", "w") as f:
